...
export default function NewReelPage() {
  ...
  const onSubmit: SubmitHandler<ReelFormValues> = async (data) => {
    ...
    try {
      ...
      uploadedOriginalVideoUrl = await getDownloadURL(videoFileRef);
      toast({ title: "Video Uploaded", description: "Reel video successfully uploaded." });

      // For now, display URL is the original. The Resize Images/Video Transcoding extension
      // would create other versions. A thumbnail URL might also be generated by an extension.
      const displayVideoUrl = uploadedOriginalVideoUrl;
      const videoThumbnailUrl = null; // Placeholder: An extension could generate this.

      const reelDetailsToSave = {
        videoUrl: displayVideoUrl, // Primary URL for display
